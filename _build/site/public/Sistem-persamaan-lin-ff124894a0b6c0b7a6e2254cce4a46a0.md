...
1. Tinjau $( \sqrt{3x} + sin(5) = 2x - e^4 y)$. Ini adalah persamaan linear dalam peubah (4 x, y, z \). Bentuk bakunya adalah $( \sqrt{3x} + e^4 y - 2x = -\sin(5) )$. Karena ruas kanannya tak nol, persamaan ini bersifat nonhomogen.
