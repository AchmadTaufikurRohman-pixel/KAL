...
\textbf{Definisi 1.2.3. Sistem Persamaan Linear.} 
Sebuah \textit{sistem persamaan linear} (atau \textit{sistem linear}) adalah himpunan persamaan linear.

Sebuah sistem linear disebut \textit{homogen} jika seluruh persamaannya homogen.
